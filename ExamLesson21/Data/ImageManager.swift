...
class ImageManager: IManager{
    func getImages() -> [ImageModel] {
        [
            ImageModel(imageName: ImageViewType.cat1.rawValue, text: TextData.firstImageText, isMark: false),
            ...
            ImageModel(imageName: ImageViewType.enot1.rawValue, text: TextData.fourthImageText, isMark: false)
        ]
    }
}
